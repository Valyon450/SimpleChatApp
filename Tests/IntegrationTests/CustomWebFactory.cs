...
namespace IntegrationTests
{
        ...
        WebApplicationFactory<TProgram> where TProgram : class
    {
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                var dbContextDescriptor =
                    services.SingleOrDefault(x => x.ServiceType == typeof(DbContextOptions<SimpleChatDbContext>));
                ...
                using (var scope = sp.CreateScope())
                {
                    ...
                    var context = scopedServices.GetRequiredService<SimpleChatDbContext>();
        ...
        private void SeedTestDatabase(SimpleChatDbContext context)
        {
